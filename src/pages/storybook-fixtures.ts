...
export const storyProjectIssues = [
  ...
  makeIssue('FC-206', 'Test case creation and execution', 'In Progress', storyAssigneeQa, 'FC-150', 8),
...
export const storyIssueChildren = {
  issues: [
    makeIssue('FC-189', 'Content carousel nested child story', 'To Do', storyAssigneeQa, 'FC-207', 2),
    makeIssue(
      'FC-190',
